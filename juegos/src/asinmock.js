...
const misProductos = [
    {id: "1", nombre:"The last of us",stock:5, description: 'The Last of Us es un videojuego de genero Drama, Survival Horror y Acción-Aventura en tercera persona desarrollado por Naughty Dog y publicado por Sony Interactive Entertainment.', precio: 1200, img:"../imagen/thelastofus.png", idCat:"Historia"},
    {id: "2", nombre:"Black Myth: Wukong",stock:5,description: 'Black Myth: Wukong es un RPG de acción basado en la mitología china y en Viaje al Oeste, una de las cuatro grandes novelas clásicas de la literatura china.', precio: 2200, img:"../imagen/Wokong.jpg", idCat:"Soul", },
    {id: "3", nombre:"Elden Ring",stock:5,description: 'Es un RPG de fantasía, acción y aventura ambientado en un mundo creado por Hidetaka Miyazaki y George R. R. Martin. El peligro y el descubrimiento están en cada giro del juego más grande de FromSoftware hasta la fecha.', precio: 1200, img:"../imagen/Eldenring.jpg", idCat:"Soul"},
